...
namespace Project.Gameplay.Map
{
    ...
    public sealed class MatchConfig : ScriptableObject
    {
        ...
        public sealed class WaterSettings
        {
            ...
            [Tooltip("Si esta activo, Water Visual Pipeline de este MatchConfig pisa el valor del MapGenConfig tecnico.")]
            public bool overrideVisualPipeline = false;
            public WaterVisualPipelineMode visualPipeline = WaterVisualPipelineMode.CurrentSplitLakeMsRiverSurface;
            public int waterLayer = -1;
            public Material material;
            public WaterMaterialRuntimeMode materialMode = WaterMaterialRuntimeMode.SW2ProceduralTranslator;
            public Material riverMaterial;
            public WaterMaterialRuntimeMode riverMaterialMode = WaterMaterialRuntimeMode.DirectAsset;
            public Material tributaryMaterial;
            public WaterMaterialRuntimeMode tributaryMaterialMode = WaterMaterialRuntimeMode.DirectAsset;
            public Material lakeMaterial;
            public WaterMaterialRuntimeMode lakeMaterialMode = WaterMaterialRuntimeMode.DirectAsset;
            public Material seaMaterial;
            public WaterMaterialRuntimeMode seaMaterialMode = WaterMaterialRuntimeMode.SW2ProceduralTranslator;
        ...
        public sealed class PlayerSlotSettings
        {
            ...
            [Tooltip("Solo aplica si kind = AI. 0=Easy, 1=Normal, 2=Hard.")]
        ...
        {
            public ScriptableObject townCenter;
